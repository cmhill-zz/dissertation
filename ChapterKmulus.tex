...
One strategy to improve the separability of the clusters and reduce the k-mer intersection between clusters is to use repeat masking software.
...
%However, clustering these databases with a stringent enough criteria to get few k-mer intersections often results in clusters of very little size\cite{li2002tolerating}.
