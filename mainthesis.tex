...
\include{ChapterLAP}
\include{Chapter2}
\include{ChapterAutomatedTesting}
\include{Chapter3}
\include{ChapterKmulus}
...
\bibliography{Chapter1,Chapter2,ChapterAutomatedTesting,Chapter3,ChapterKmulus} %replace "Galactic,Dottie" with the
